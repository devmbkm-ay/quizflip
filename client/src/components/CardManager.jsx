        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-6">
            ...
            <div
              ...
              className="p-2 text-slate-500 hover:text-slate-300 hover:bg-slate-900/30 rounded-lg cursor-pointer transition-colors"
              title="Go Back"
            >
              <svg
                className="w-5 h-5"
            ...
            <div className="w-48 shrink-0">
              <h1 className="text-xl font-bold text-white">Card Manager</h1>
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-medium transition-all hover:shadow-lg hover:shadow-indigo-500/25 whitespace-nowrap"
            >
              <svg
                className="w-5 h-5"
                fill="none"
